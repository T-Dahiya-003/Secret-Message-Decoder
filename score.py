...
if "B" in response2.upper():
    ...
    score -=20
elif "A" in response2.upper():
    score -=20
elif "C" in response2.upper():
    score -=20


if score == 20: 
    print( "You cracked the cryptic note and found the true meaning behind \"oskza ohupo\"!" )
elif score > 0:
    print( "oops!  try decrypting the note again!" )
else: 
    print( " Try Again!")